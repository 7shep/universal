...
allowed-tools: Read, Glob, Grep, Bash(git status:*), Bash(git diff:*), Bash(git log:*), Skill, AskUserQuestion, mcp__universal__get_design_rules, mcp__universal__get_taste_profile, mcp__universal__review_implementation
argument-hint: '[design question] [route/component]'
