...
allowed-tools: Read, Glob, Grep, Bash(git status:*), Bash(git diff:*), Bash(git log:*), Skill, AskUserQuestion, mcp__universal__get_design_rules, mcp__universal__get_taste_profile, mcp__universal__review_implementation, mcp__universal__get_art_direction_session
argument-hint: '[route/component] [reference: screenshot|mockup path|URL|DESIGN.md|selected direction]'
