import type { DesignTokens, PageSection, PresetName } from '@universal/design-engine';

export type { DesignTokens, PageSection, PresetName } from '@universal/design-engine';
