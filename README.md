...
| <code>[/responsive](docs/skills/responsive.md)</code> | Reviews and repairs overflow, wrapping, navigation, touch targets, content order, density, and breakpoint composition across representative viewport widths. | Yes                 |
