...
| <code>[/typography](docs/skills/typography.md)</code> | Refines font selection/loading, type scale, hierarchy, line length, weight, and vertical rhythm without changing layout or color.                | Yes                 |
