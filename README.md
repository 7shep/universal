...
| [<code>/states</code>](docs/skills/states.md) | Finds and completes missing interaction/application states (hover, focus-visible, active, selected, disabled, loading, empty, error, success, skeleton). | Yes                 |
