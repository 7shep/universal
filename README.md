...
| [<code>/accessibility</code>](docs/skills/accessibility.md) | Audits accessibility with WCAG 2.2-cited findings; repairs semantics, keyboard, focus, labels, contrast, touch targets, and reduced-motion support only when explicitly requested. | Only when requested |
