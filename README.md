...
| <code>[/document](docs/skills/document.md)</code> | Creates or updates a Google Stitch-compatible <code>DESIGN.md</code> from the actual implementation.                                             | Yes, docs only      |
