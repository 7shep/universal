...
| <code>[/animate](docs/skills/animate.md)</code> | Adds purposeful motion — transitions, micro-interactions, scroll effects, loading feedback — with reduced-motion fallbacks.                      | Yes                 |
