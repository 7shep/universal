...
| [`/final-pass`](docs/skills/final-pass.md) | Orchestrates a release-readiness pass across `/audit`, `/responsive`, `/accessibility`, `/states`, `/performance`, `/consistency`, `/compare`, and `/polish`, applies bounded fixes, and reports a ready / ready-with-caveats / not-ready verdict. | Yes, within a fix budget |
