...
| [/layout](docs/skills/layout.md) | Improves composition, alignment, whitespace, section pacing, density, and visual hierarchy without redesigning or changing behavior.             | Yes                 |
