...
- `/compare` — **IN PROGRESS:** compare the current implementation against a supplied screenshot, mockup, reference URL, `DESIGN.md`, or selected direction, and report prioritized differences.
