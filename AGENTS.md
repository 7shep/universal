...
- `/copy` — **IN PROGRESS:** improve interface language — headings, CTAs, nav labels, form/help text, empty states, errors, and confirmations — without changing meaning or behavior.
