...
- `/color` — **IN PROGRESS:** improve palette cohesion, semantic color roles, contrast, interaction-state colors, and design-token usage without changing the established palette.
