...
- `/responsive` — **IN PROGRESS:** review and repair overflow, wrapping, navigation, touch targets, content order, density, and breakpoint-specific composition across representative viewport widths.
