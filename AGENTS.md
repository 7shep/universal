...
- `/accessibility` — **IN PROGRESS:** audit accessibility with WCAG 2.2-cited findings; repair semantics, keyboard interaction, focus behavior, labels, contrast, touch targets, and reduced-motion support only when explicitly requested.
